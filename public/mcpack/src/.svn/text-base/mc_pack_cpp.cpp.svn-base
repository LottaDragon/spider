...
/**
 * @file src/mc_pack_cpp.cpp
 * @author yufan(com@baidu.com)
 * @date 2009/03/02 16:46:19
 * @brief 
 *  
 **/
...
int Mcpack::get_double_from_item(const mc_pack_item_t * , double *)
{
	return MC_PE_PROTOCOL_NOT_SUPPOT_OPERATION;
}
...
int Mcpack::put_double(const char *, double )
{
	return MC_PE_PROTOCOL_NOT_SUPPOT_OPERATION;
}

int Mcpack::get_double(const char *, double * )
{
	return MC_PE_PROTOCOL_NOT_SUPPOT_OPERATION;
}

int Mcpack::get_double_index(size_t , double * )
{
	return MC_PE_PROTOCOL_NOT_SUPPOT_OPERATION;
}

int Mcpack::mod_double(const char *, double )
{
	return MC_PE_PROTOCOL_NOT_SUPPOT_OPERATION;
}

int Mcpack::mod_double_index(size_t , double )
{
	return MC_PE_PROTOCOL_NOT_SUPPOT_OPERATION;
}
