...
char char_map::map[256]; 
*/
/*
class Protocol_v1 : public mc_pack_t
{
};
*/
 ...
 int mc_pack_put_double(mc_pack_t * ppack, const char *name, double value)
{
	...
	return pack->put_double(name,value);
}

 int mc_pack_get_double(const mc_pack_t * ppack, const char *name, double *value)
{
	Mcpack * pack = (Mcpack *)ppack;
	if(pack->magic_check())
	{
	...
	return pack->get_double(name, value);
}

 int mc_pack_get_double_arr(const mc_pack_t * ppack, u_int arr_index, double *value)
{
	Mcpack * pack = (Mcpack *)ppack;
	if(pack->magic_check())
	{
	...
	return pack->get_double_index(arr_index, value);
}
...
int mc_pack_get_double_from_item(const mc_pack_item_t *pitem, double *res)
{
	...
	return pack->get_double_from_item(pitem, res);	
...
void * mc_pack_get_buffer(mc_pack_t * ppack)
{
	if(0 == ppack)
	{
		return (void *)MC_PE_BAD_PARAM; 
...
int mc_pack_mod_double(mc_pack_t * ppack, const char *name, double value)
{
	Mcpack * pack = (Mcpack *)ppack;
	if(pack->magic_check())
	{
	...
	return pack->mod_double(name,value);
}

int mc_pack_mod_double_arr(mc_pack_t * ppack, u_int arr_index, double value)
{
	Mcpack * pack = (Mcpack *)ppack;
	if(pack->magic_check())
	{
	...
	return pack->mod_double_index(arr_index, value);
}
