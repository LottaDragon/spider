...
class Protocol_v1 : public Mcpack
{
	mc_v1pack_t * _ppack;
	alloc_t * _alloc;
...
template <typename alloc_t>
int Protocol_v1<alloc_t>::get_double_from_item(const mc_pack_item_t * item, double *res) 
{
	return mc_v1pack_get_double_from_item(item, res);
}
...
template <typename alloc_t>
int Protocol_v1<alloc_t>::put_double(char const * name, double value)
{
	return mc_v1pack_put_double(_ppack, name, value);	
}

template <typename alloc_t>
int Protocol_v1<alloc_t>::get_double(char const * name, double *value)
{
	return mc_v1pack_get_double(_ppack, name, value);	
}

template <typename alloc_t>
int Protocol_v1<alloc_t>::get_double_index(size_t in, double *value)
{
	return mc_v1pack_get_double_arr(_ppack, in, value);	
}
template <typename alloc_t>
