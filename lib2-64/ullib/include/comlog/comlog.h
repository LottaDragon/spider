 ...
 * $Id: comlog.h,v 1.3 2009/07/03 06:08:44 zhangfang Exp $ 
 * 
 **************************************************************************/
...
struct com_device_t
{
	...
	u_int64 log_mask;		//½ÓÊÕÄÄĞ©µÈ¼¶ÈÕÖ¾£¬Ä¬ÈÏÎª0±íÊ¾½ÓÊÕÏµÍ³µÈ¼¶ÈÕÖ¾,ADD_MASK, DEL_MASK ºêÀ´¿ØÖÆ			
