 ...
 * $Id: bsl_exception.h,v 1.5 2009/06/26 07:24:14 zhangfang Exp $ 
 * 
 **************************************************************************/
    ...
    */
    ...
    public:
        ...
        ExceptionBase()
            ...
            _stack(DEFAULT_STACK_CAPACITY), _name(DEFAULT_NAME_CAPACITY), _msg(DEFAULT_WHAT_CAPACITY), _arg(DEFAULT_FUNCTION, DEFAULT_FILE, DEFAULT_LINE){
            }
